...
import { AppBar, IconButton, Typography, Menu, MenuItem, Container, Button, Tooltip, Toolbar, Avatar, Box } from '@mui/material';
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box component={Link} to="/" sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }}>
                <img src={logoIcon} alt="Dear Dir Icon" height={20} />
          </Box>
